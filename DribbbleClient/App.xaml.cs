...
namespace DribbbleClient
{
    public partial class App : Application
    {
        ...
        {
            new UmengRegisterEventHelper().RegisterUmengEventByType(AnalysicEventType.AppLaunching);
        }
        ...
        {
            new UmengRegisterEventHelper().RegisterUmengEventByType(AnalysicEventType.AppActivated);
        }
